...
<head>
    ...
    <link rel="stylesheet" href="videojuegos/videojuegos.css?v=2">
    <link rel="stylesheet" href="consolas/consolas.css?v=2">
    <link rel="stylesheet" href="perifericos/perifericos.css?v=2">
    <link rel="stylesheet" href="checkout/checkout.css?v=2">
    <link rel="stylesheet" href="valoraciones/valoraciones.css?v=2">
    <link rel="stylesheet" href="pedidos/pedidos.css?v=2">
    <link rel="stylesheet" href="perfil/perfil.css?v=2">
    <link rel="stylesheet" href="admin/admin.css?v=2">
    <link rel="stylesheet" href="producto/producto.css?v=2">
...
<body>
                ...
                <div class="info-dropdown" id="infoDropdown">
                    ...
                    <div class="info-social-icons">
                        ...
                        <a href="https://discord.com" target="_blank" rel="noopener" class="info-social"
                            title="Discord"><i class="fa-brands fa-discord"></i></a>
                    </div>
                </div>
            </div>
            ...
            <?php else: ?>
                <div class="icon-item info-dropdown-container" id="perfilToggle">
                    ...
                    <div class="info-dropdown" id="perfilDropdown">
                        ...
                        <div class="info-dropdown-section">
                            <a href="log-in/logout.php" class="info-item" style="text-decoration:none; color:inherit;">
                                <span class="info-icon">🚪</span>
    ...
    <footer class="footer-main">
        <div class="footer-social-bar">
            ...
            <a href="https://www.instagram.com" target="_blank" rel="noopener" class="social-icon"
                title="Instagram"><i class="fa-brands fa-instagram"></i></a>
            <a href="https://www.x.com" target="_blank" rel="noopener" class="social-icon" title="Twitter/X"><i class="fa-brands fa-x-twitter"></i></a>
            <a href="https://www.youtube.com" target="_blank" rel="noopener" class="social-icon" title="YouTube"><i class="fa-brands fa-youtube"></i></a>
            <a href="https://discord.com" target="_blank" rel="noopener" class="social-icon" title="Discord"><i class="fa-brands fa-discord"></i></a>
        </div>
    ...
    <script src="carrito/carrito.js?v=2"></script>
    <!-- JS de cada sección -->
    <script src="home/home.js?v=2"></script>
    <script src="videojuegos/videojuegos.js?v=2"></script>
    <script src="consolas/consolas.js?v=2"></script>
    <script src="perifericos/perifericos.js?v=2"></script>
    <script src="checkout/checkout.js?v=2"></script>
    <script src="valoraciones/valoraciones.js?v=2"></script>
    <script src="pedidos/pedidos.js?v=2"></script>
    <script src="perfil/perfil.js?v=2"></script>
    <script src="producto/producto.js?v=2"></script>
    <!-- Router SPA -->
